...
#line 158 "parser.tab.cpp" /* yacc.c:355  */
};
...
{
       0,    59,    59,    60,    64,    69,    74,    95,   103,   111,
     116,   122,   125,   128,   131,   134,   137,   140,   144,   147,
     150,   154,   158,   162,   167,   173,   178,   185,   189,   195,
     198,   203,   207,   211
};
#endif
...
{
  "$end", "error", "$undefined", "def_token", "extern_token", "end_token",
  "if_token", "then_token", "else_token", "for_token", "in_token",
  "var_token", "id_token", "num_token", "':'", "'='", "'<'", "'>'", "'+'",
  "'-'", "'*'", "';'", "'('", "')'", "','", "$accept", "Program",
  "Command", "Signature", "Arguments", "Expression", "VarAssignments",
  "VarAssignment", "ForStep", "Expressions", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,    58,    61,    60,    62,    43,    45,
      42,    59,    40,    41,    44
};
# endif
...
{
      32,    -6,    -6,   -20,    54,     0,     2,   -11,   -20,    54,
       7,   -20,   102,   -19,    54,   -20,    55,    14,    19,    -9,
     -20,    54,    54,    94,   -20,    32,    54,    54,    54,    54,
      54,    54,   -20,   102,    54,    54,    54,    54,     2,    30,
     102,   -15,   -20,   -20,    30,     1,     1,    20,    20,   -20,
     -10,    69,    76,   102,    30,   -20,   -20,    54,   -20,   -20,
      54,    54,   102,    30,    85,    54,     6,   102,    54,    30
};
...
{
       0,     0,     0,     7,     0,     0,     0,    22,    24,     0,
       0,     3,     6,     0,     0,     5,     0,     0,    28,     0,
      26,     0,    33,     0,     1,     0,     0,     0,     0,     0,
       0,     0,    10,     4,     0,     0,     0,     0,     0,    17,
      32,     0,    18,     2,    16,    15,    14,    11,    12,    13,
       0,     0,     0,    27,    21,    25,    23,     0,     9,     8,
       0,     0,    31,    19,    30,     0,     0,    29,     0,    20
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -20,   -20,    17,    37,   -20,    -4,   -20,    13,   -20,   -20
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,    10,    11,    14,    50,    12,    19,    20,    66,    41
};
...
{
      16,    37,    58,    32,    21,    23,    13,    24,    56,    57,
      33,    22,    17,    59,    18,    38,    68,    39,    40,    29,
      30,    31,    44,    45,    46,    47,    48,    49,    25,    35,
      51,    52,    53,    54,    36,     1,     2,     3,     4,    15,
      31,     5,    43,     6,     7,     8,    27,    28,    29,    30,
      31,    55,     0,    62,     9,     0,    63,    64,     0,     0,
       4,    67,    34,     5,    69,     6,     7,     8,     0,    26,
       0,    27,    28,    29,    30,    31,     9,    60,     0,     0,
       0,     0,     0,    26,     0,    27,    28,    29,    30,    31,
      26,     0,    27,    28,    29,    30,    31,     0,     0,    26,
      61,    27,    28,    29,    30,    31,     0,     0,    26,    65,
      27,    28,    29,    30,    31,     0,    26,    42,    27,    28,
      29,    30,    31
};

static const yytype_int8 yycheck[] =
{
       4,    10,    12,    22,    15,     9,    12,     0,    23,    24,
      14,    22,    12,    23,    12,    24,    10,    21,    22,    18,
      19,    20,    26,    27,    28,    29,    30,    31,    21,    15,
      34,    35,    36,    37,    15,     3,     4,     5,     6,     2,
      20,     9,    25,    11,    12,    13,    16,    17,    18,    19,
      20,    38,    -1,    57,    22,    -1,    60,    61,    -1,    -1,
       6,    65,     7,     9,    68,    11,    12,    13,    -1,    14,
      -1,    16,    17,    18,    19,    20,    22,     8,    -1,    -1,
      -1,    -1,    -1,    14,    -1,    16,    17,    18,    19,    20,
      14,    -1,    16,    17,    18,    19,    20,    -1,    -1,    14,
      24,    16,    17,    18,    19,    20,    -1,    -1,    14,    24,
      16,    17,    18,    19,    20,    -1,    14,    23,    16,    17,
      18,    19,    20
};
...
{
       0,     3,     4,     5,     6,     9,    11,    12,    13,    22,
      26,    27,    30,    12,    28,    28,    30,    12,    12,    31,
      32,    15,    22,    30,     0,    21,    14,    16,    17,    18,
      19,    20,    22,    30,     7,    15,    15,    10,    24,    30,
      30,    34,    23,    27,    30,    30,    30,    30,    30,    30,
      29,    30,    30,    30,    30,    32,    23,    24,    12,    23,
       8,    24,    30,    30,    30,    24,    33,    30,    10,    30
};
...
#line 64 "parser.ypp" /* yacc.c:1646  */
    {
	auto fun = new FunctionAST(*(yyvsp[-1].proto), (yyvsp[0].expr));
...
#line 69 "parser.ypp" /* yacc.c:1646  */
    {
	auto tmp = (yyvsp[0].proto)->codegen();
	delete (yyvsp[0].proto);
	tmp->dump();
}
...
#line 74 "parser.ypp" /* yacc.c:1646  */
	...
	FunctionAST* anonExpr = new FunctionAST(proto, (yyvsp[0].expr));
...
#line 103 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.proto) = new PrototypeAST(*(yyvsp[-3].str), *(yyvsp[-1].vec_str));
	delete (yyvsp[-3].str);
...
#line 111 "parser.ypp" /* yacc.c:1646  */
	...
	(yyval.vec_str)->push_back(*(yyvsp[0].str));
	delete (yyvsp[0].str);
}
...
#line 122 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new BinaryExprAST('+', (yyvsp[-2].expr), (yyvsp[0].expr));
}
...
#line 140 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new BinaryExprAST('=', new VariableExprAST(*(yyvsp[-2].str)), (yyvsp[0].expr));
	delete (yyvsp[-2].str);
}
...
#line 147 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new IfThenElseExprAST((yyvsp[-4].expr), (yyvsp[-2].expr), (yyvsp[0].expr));
}
...
#line 150 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new ForExprAST(*(yyvsp[-7].str), (yyvsp[-5].expr), (yyvsp[-3].expr), (yyvsp[-2].expr), (yyvsp[0].expr));
	delete (yyvsp[-7].str);
}
...
#line 154 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new VarDefExprAST(*(yyvsp[-2].vec_pair_ass), (yyvsp[0].expr));
	delete (yyvsp[-2].vec_pair_ass);
}
...
#line 158 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new VariableExprAST(*(yyvsp[0].str));
	delete (yyvsp[0].str);
}
...
#line 162 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new CallExprAST(*(yyvsp[-3].str), *(yyvsp[-1].vec_exp));
	delete (yyvsp[-3].str);
	delete (yyvsp[-1].vec_exp);
}
...
#line 167 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.expr) = new NumberExprAST((yyvsp[0].num));
}
...
#line 173 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.vec_pair_ass) = (yyvsp[-2].vec_pair_ass);
	(yyval.vec_pair_ass)->push_back(*(yyvsp[0].pair_ass));
	delete (yyvsp[0].pair_ass);
}
...
#line 178 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.vec_pair_ass) = new std::vector<std::pair<std::string, ExprAST*> >();
	(yyval.vec_pair_ass)->push_back(*(yyvsp[0].pair_ass));
	delete (yyvsp[0].pair_ass);
}
...
#line 185 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.pair_ass) = new std::pair<std::string, ExprAST*>(*(yyvsp[-2].str), (yyvsp[0].expr));
	delete (yyvsp[-2].str);
}
...
#line 189 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.pair_ass) = new std::pair<std::string, ExprAST*>(*(yyvsp[0].str), nullptr);
	delete (yyvsp[0].str);
}
...
#line 203 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.vec_exp) = (yyvsp[-2].vec_exp);
	(yyval.vec_exp)->push_back((yyvsp[0].expr));
}
...
#line 207 "parser.ypp" /* yacc.c:1646  */
    {
	(yyval.vec_exp) = new std::vector<ExprAST*>();
	(yyval.vec_exp)->push_back((yyvsp[0].expr));
}
...
#line 216 "parser.ypp" /* yacc.c:1906  */
